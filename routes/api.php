...
use App\Http\Controllers\Admin\Ad_requestController;
...
*/
// public routes
Route::post("/test", [OrderController::class, 'test'])->name('test');
...
Route::post('/productList/{id}', [ProductController::class, 'productList'])->name('productList');
...
Route::get('/getUserUsingShopID/{id}', [AuthController::class,'getUserUsingShopID'])->name('getUserUsingShopID');
Route::get('/getUserByID/{id}', [AuthController::class,'getUserByID'])->name('getUserByID');
...
Route::group(["middleware"=> "auth:sanctum"], function () {
    ...
    Route::get('/emptyCard', [CartController::class, 'emptyCard'])->name('emptyCard');
    ...
    Route::get("/ordersCounter", [OrderController::class, 'ordersCounter'])->name('ordersCounter');
    Route::get("/transactionList", [OrderController::class, 'transactionList'])->name('transactionList');
    Route::post("/getUserOrders", [OrderController::class, 'getUserOrders'])->name('getUserOrders');
    ...
    Route::post("/createAd", [Ad_requestController::class, 'createAd'])->name('createAd');
    Route::get("/adsList", [Ad_requestController::class, 'adsList'])->name('adsList');
    Route::post("/updateAd/{id}", [Ad_requestController::class, 'updateAd'])->name('updateAd');
    Route::post("/adClick", [Ad_requestController::class, 'adClick'])->name('adClick');
