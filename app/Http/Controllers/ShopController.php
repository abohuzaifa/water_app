...
class ShopController extends Controller
{
    ...
    {
        $data['perPage'] = 10;
        $shop =Shop::orderByDesc('id')->paginate($data['perPage']);
    ...
    {
        DB::table('shops')->where('id', $shop->id)->update(['status' => 0]);
        return redirect()->route('shop.index')->with('success', trans("lang.shop_delete_message"));
    }
}
