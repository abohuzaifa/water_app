      ...
      <ul class="d-flex align-items-center">
        ...
        <li class="nav-item dropdown">
          <a class="nav-link nav-icon" href="#" data-bs-toggle="dropdown">
            ...
            <span class="badge bg-primary badge-number">{{count($new_users) == 0 ? "" : count($new_users)}}</span>
        ...
        <li class="nav-item dropdown">
          ...
          <a class="nav-link nav-icon" href="#" data-bs-toggle="dropdown">
            ...
            <span class="badge bg-success badge-number">{{count($contacts) == 0 ? "" : count($contacts)}}</span>
          </a> 

          <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow messages">
            
            <li class="dropdown-header">
            {{trans('lang.you_have')}} {{count($contacts)}} {{trans('lang.new_messages')}}
              <a href="{{ route('contact.edit',['all', "choice" => "is_read"]) }}"><span class="badge rounded-pill bg-primary p-2 ms-2">{{trans('lang.view_all')}}</span></a>
            </li>
            <li>
              <hr class="dropdown-divider">
            </li>
            ...
            <li class="message-item">
              <a href="'. route('contact.edit',[$con->id]) .'">
                ...
                <div>
                  ...
                  <p>{{$con->subject}}</p>
                  <p>{{$con->message}}</p>
                  <p>{{formatCreatedAt($con->created_at)}}</p>
                </div>
              </a>
            </li>
            <li>
          ...
          <?php } ?>
            ...
            <li class="dropdown-footer">
              <a href="{{ route('contact.edit',['all', "choice" => "is_read"]) }}">{{trans('lang.show_all_messages')}}</a>
            </li>
